...
local Palette = {
    ...
    Card        = Color3.fromRGB(38, 38, 49),   -- sumiInk3
    RowItem     = Color3.fromRGB(38, 38, 49),
...
local function ApplyNeuShadow(frame, raised)
    -- Light shadow (top-left offset frame)
    local shadowLight = Instance.new("Frame", frame.Parent)
    shadowLight.Name = "NeuShadowLight"
    shadowLight.ZIndex = frame.ZIndex - 1
    shadowLight.Size = frame.Size
    shadowLight.Position = UDim2.new(
        frame.Position.X.Scale, frame.Position.X.Offset - 3,
        frame.Position.Y.Scale, frame.Position.Y.Offset - 3
    )
    shadowLight.BackgroundColor3 = raised and Palette.ShadowLight or Palette.ShadowDark
    shadowLight.BackgroundTransparency = 0.5
    shadowLight.BorderSizePixel = 0
    local c1 = Instance.new("UICorner", shadowLight)
    c1.CornerRadius = UDim.new(0, 12)

    -- Dark shadow (bottom-right offset frame)
    local shadowDark = Instance.new("Frame", frame.Parent)
    shadowDark.Name = "NeuShadowDark"
    shadowDark.ZIndex = frame.ZIndex - 1
    shadowDark.Size = frame.Size
    shadowDark.Position = UDim2.new(
        frame.Position.X.Scale, frame.Position.X.Offset + 3,
        frame.Position.Y.Scale, frame.Position.Y.Offset + 3
    )
    shadowDark.BackgroundColor3 = raised and Palette.ShadowDark or Palette.ShadowLight
    shadowDark.BackgroundTransparency = 0.5
    shadowDark.BorderSizePixel = 0
    local c2 = Instance.new("UICorner", shadowDark)
